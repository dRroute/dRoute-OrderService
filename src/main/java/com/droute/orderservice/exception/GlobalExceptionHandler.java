...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<CommonResponseDto<Order>> entityNotFoundException(EntityNotFoundException exception) {
	...
	public ResponseEntity<CommonResponseDto<Order>> entityAlreadyExistException(
	...
	public ResponseEntity<CommonResponseDto<Order>> handleBadRequest(BadRequestException exception) {
